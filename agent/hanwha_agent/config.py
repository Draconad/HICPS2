...
class Config:
    ...
    # save a few seconds of video around each alarm (a rolling recording is kept on this PC and cut from)
    camera_clips: bool = False
    camera_delay_s: float = 12.0      # how far the camera picture runs behind real life - the clip is shifted by it
    clip_pre_s: float = 15.0          # seconds before the alarm
    clip_post_s: float = 10.0         # and after
